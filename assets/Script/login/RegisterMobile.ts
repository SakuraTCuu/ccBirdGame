...
@ccclass
export default class RegisterMobile extends cc.Component {
    ...
    onRegisterClick() {
        ...
        this.node.parent.getComponent(Login).doRegisterAction(param);
    }
    ...
    onCodeClick() {
        ...
        this._isTiming = true;
        HTTPMgr.post(HTTPPath.REGISTERSMS, param).then(() => {
            this.doStartTime();
        }).catch((err) => {
